 ...
 */
public abstract class WalkGenerationManager implements IWalkGenerationManager {
     ...
     * Default logger
     */
    private static Logger LOGGER = LoggerFactory.getLogger(WalkGenerationManager.class);
