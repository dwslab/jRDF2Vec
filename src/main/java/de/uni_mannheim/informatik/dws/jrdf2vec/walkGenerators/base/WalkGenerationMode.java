 ...
 *      This affects, for example {@link WalkGeneratorDefault#generateWalks(WalkGenerationMode, int, int, int, String)} or {@link de.uni_mannheim.informatik.dws.jrdf2vec.walkGenerators.light.WalkGeneratorLight#generateWalks(WalkGenerationMode, int, int, int, String)}.
 * </li>
 * </ul>
 */
